...
params_p2k = comp_params(cpm_gev_params.Parameters, temperature=delta + 2*cet_scale) # check scaling value
...
mn_radar = {key: fit.Parameters.mean('sample') for key, fit in radar_fit.items()}
# sampling uncert.
